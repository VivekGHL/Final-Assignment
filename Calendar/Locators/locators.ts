export const Locators = {
    nextMonthButton : '//button[@class="vdpArrow vdpArrowNext"]',
    ...
    bookAppointmentButton : '//button[@class="hl_button --primary button-element"]',

    confirmationText : '//div[@class="hl_widget-body"]/p'
